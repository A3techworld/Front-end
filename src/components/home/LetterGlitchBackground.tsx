...
interface LetterGlitchBackgroundProps {
  glitchColors?: string[] | 'primary' | 'accent' | 'secondary';
  glitchSpeed?: number;
...
const getThemeColors = (colorType: string | string[] = 'primary'): string[] => {
  if (Array.isArray(colorType)) return colorType;
  
  // Default theme colors that work with both light and dark modes
...
const LetterGlitchBackground = ({
  ...
  const colors = getThemeColors(glitchColors);
  ...
  }, [glitchSpeed, smooth, glitchColors, characters, opacity, colors]);
