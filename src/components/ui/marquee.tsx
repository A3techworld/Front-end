...
export const Marquee = React.forwardRef<HTMLDivElement, MarqueeProps>(
  ({
    ...
    return (
      ...
      >
        <>
          <div className="absolute left-0 top-0 bottom-0 w-8 md:w-[20%] bg-gradient-to-r from-background to-transparent z-10" />
          <div className="absolute right-0 top-0 bottom-0 w-8 md:w-[20%] bg-gradient-to-l from-background to-transparent z-10" />
        </>
        <motion.div
          ...
          {[...Array(repeat)].map((_, index) => (
            <div key={index} className="flex items-center mx-4">
              <span
                ...
                style={{
                  WebkitTextStroke: `${strokeWidth} hsl(var(--primary))`,
                }}
              >
                {text}
              </span>
