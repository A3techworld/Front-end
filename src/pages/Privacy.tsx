      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            ...
            <li><strong>Website</strong> refers to a3techworld.com, accessible from <a href="https://a3techworld.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://a3techworld.com/</a></li>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-2">Use of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-2">Retention of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-2">Transfer of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-2">Delete Your Personal Data</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-2">Disclosure of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-2">Security of Your Personal Data</h3>
